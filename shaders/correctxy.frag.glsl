...
void main() {
    ...
    float segmentAngle = segmentAngleWithGap - segment_gap; // Angular width of a segment
    ...
    // Step 12: Calculate the index of the hovered segment
    int hoverSegmentIndex = int(mouse_angle / segmentAngleWithGap);
